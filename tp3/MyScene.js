...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.ambientLightRed = 0.3;
        this.ambientLightGreen = 0.3;
        this.ambientLightBlue = 0.3;
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.ambientLightRed, this.ambientLightGreen, this.ambientLightBlue, 1);
